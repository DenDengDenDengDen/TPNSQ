<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\banner\edit.html";i:1591694195;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1591688415;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">主标题</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail23" name="lname" value="<?php echo $data['name']; ?>" placeholder="主标题名称(长度:1-20位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">副标题</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" value="<?php echo $data['lname']; ?>" placeholder="副标题名称(长度:1-50位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputPassword13" class="col-sm-2 control-label no-padding-right">按钮名称</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword13" name="btn_name" value="<?php echo $data['btn_name']; ?>" placeholder="请输入按钮名称(长度:1-10位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">跳转网址</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword3" name="url" value="<?php echo $data['url']; ?>" placeholder="请输入完成的跳转路径">
													</div>
												</div>

												<div class="form-group">
													<label for="inputPassword6" class="col-sm-2 control-label no-padding-right">轮播排序</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword6" name="sort" value="<?php echo $data['sort']; ?>" placeholder="请输入排序值,数值越小排名越靠前">
													</div>
												</div>
