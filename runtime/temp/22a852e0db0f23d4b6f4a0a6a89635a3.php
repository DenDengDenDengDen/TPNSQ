<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\link\edit.html";i:1592377556;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592294140;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">图片(建议尺寸:214*92)</label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">图片(建议尺寸:214*92)</label>
													<div class="col-sm-10">
														<img src="<?php echo $data['img']; ?>" style="width:214px;height:92px;" alt="">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" value="<?php echo $data['name']; ?>" placeholder="链接名称(长度:1-20位)">
													</div>
												</div>
...
<!--													<div class="col-sm-10">-->
<!--														<input type="text" class="form-control" id="inputPassword3" name="url" value="<?php echo $data['url']; ?>" placeholder="请输入友情链接地址">-->
<!--													</div>-->
<!--												</div>-->
