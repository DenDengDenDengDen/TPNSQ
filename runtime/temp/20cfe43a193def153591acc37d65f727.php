<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\article\edit.html";i:1592295592;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592294140;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">文章标题</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" value="<?php echo $data['name']; ?>" placeholder="文章标题(长度:1-20位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<select class="form-control" name="cate_id">
															...
															<option value="<?php echo $v['id']; ?>" <?php if($data['cate_id'] == $v['id']): ?>selected="selected"<?php endif; ?> ><?php echo $v['name']; ?></option>
															<?php endforeach; ?>
														</select>
													</div>
												</div>
												...
												<div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">作者</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword3" name="author" value="<?php echo $data['author']; ?>" placeholder="请输入作者名(长度:1-20位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">文章来源</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail23" value="<?php echo $data['origin']; ?>" name="origin" placeholder="请输入文章来源">
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail323" class="col-sm-2 control-label no-padding-right">文章关键词</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail323" value="<?php echo $data['keywords']; ?>" name="keywords" placeholder="请输入文章关键词">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<textarea name="desc" cols="30" rows="10" class="form-control" placeholder="请输入文章简介(长度不超过255)"><?php echo $data['desc']; ?></textarea>
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">内容</label>
													<div class="col-sm-10">
