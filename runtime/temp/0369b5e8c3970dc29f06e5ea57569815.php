<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\index\link.html";i:1592819862;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">合作伙伴管理</span>
                            ...
                            <div class="widget-body">
                                <div class="table-toolbar">
                                    <a id="editabledatatable_new" href="/Admin/Link/add" class="btn btn-default">
                                        新增伙伴
                                    </a>
                                </div>
                                <div role="grid" id="editabledatatable_wrapper"
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable no-footer"
                                        ...
                                        <tr class="odd">
                                            <td class="sorting_1"><img style="width:107px;height:46px;" src="<?php echo $v['img']; ?>" alt="<?php echo $v['name']; ?>"></td>
                                            <td class=" "><?php echo $v['name']; ?></td>
                                            <td class="center  "><?php echo $v['sort']; ?></td>
                                            <td class=" ">
                                                <a href="/Admin/Link/edit/id/<?php echo $v['id']; ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>
                                                    修改</a>
                                                <a href="/Admin/Link/delete/id/<?php echo $v['id']; ?>" class="btn btn-danger btn-xs delete"><i
