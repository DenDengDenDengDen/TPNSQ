<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\article\index.html";i:1591779570;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="table-toolbar">
                                    <a id="editabledatatable_new" href="/Admin/Article/add" class="btn btn-default">
                                        新增文章
                                    </a>
                                </div>
                                <div role="grid" id="editabledatatable_wrapper"
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable no-footer"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class=" "><?php echo $v['c_name']; ?></td>
                                            <td class=" "><?php echo $v['origin']; ?></td>
                                            <td class="center  "><?php echo date("Y-m-d", $v['create_time']); ?></td>
                                            <td class=" ">
                                                <a href="/Admin/Article/edit/id/<?php echo $v['id']; ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>
                                                    修改</a>
                                                <a href="/Admin/Article/delete/id/<?php echo $v['id']; ?>" class="btn btn-danger btn-xs delete"><i
