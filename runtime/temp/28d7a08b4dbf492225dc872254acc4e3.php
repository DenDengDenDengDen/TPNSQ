<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\index\banner.html";i:1591694342;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592019547;}*/ ?>
﻿<!DOCTYPE html>
<!--
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">首页轮播图管理</span>
                            ...
                            <div class="widget-body">
                                <div class="table-toolbar">
                                    <a id="editabledatatable_new" href="/Admin/Banner/add" class="btn btn-default">
                                        新增轮播
                                    </a>
                                </div>
                                <div role="grid" id="editabledatatable_wrapper"
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable no-footer"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 331px;">
                                                操作
                                            </th>
                                        </tr>
                                        </thead>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class=" "><?php echo $v['btn_name']; ?></td>
                                            <td class=" "><?php echo $v['url']; ?></td>
                                            <td class="center  "><?php echo $v['sort']; ?></td>
                                            <td class=" ">
                                                <a href="/Admin/Banner/edit/id/<?php echo $v['id']; ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>
                                                    修改</a>
                                                <a href="/Admin/Banner/delete/id/<?php echo $v['id']; ?>" class="btn btn-danger btn-xs delete"><i
