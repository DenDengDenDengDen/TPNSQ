<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\product\edit.html";i:1592295861;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592378863;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">产品名称</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" value="<?php echo $data['name']; ?>" placeholder="产品名称(长度:1-20位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">产品英文名</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword3" name="e_name" value="<?php echo $data['e_name']; ?>" placeholder="请输入产品英文名(长度:1-50位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">产品icon图片(建议尺寸:57*46)</label>
													<div class="col-sm-10">
														<input type="file" class="form-control" id="inputEmail23" name="icon">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label for="inputEmail323" class="col-sm-2 control-label no-padding-right">产品关键词</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail323" value="<?php echo $data['keywords']; ?>" name="keywords" placeholder="请输入产品关键词">
													</div>
												</div>

												<div class="form-group">
													<label class="col-sm-2 control-label no-padding-right">产品简介</label>
													<div class="col-sm-10">
														<textarea name="desc" cols="30" rows="10" class="form-control" placeholder="请输入产品简介(长度不超过255)"><?php echo $data['desc']; ?></textarea>
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">产品详情</label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword6" name="sort" value="1" placeholder="请输入排序值,数值越小排名越靠前">
													</div>
												</div>
