<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\product\index.html";i:1591759367;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="table-toolbar">
                                    <a id="editabledatatable_new" href="/Admin/Product/add" class="btn btn-default">
                                        新增产品
                                    </a>
                                </div>
                                <div role="grid" id="editabledatatable_wrapper"
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable no-footer"
                                        ...
                                        <tr class="odd">
                                            <td class="sorting_1"><img src="<?php echo $v['icon']; ?>" style="width:57px;height:46px;" alt=""></td>
                                            <td class=" "><?php echo $v['name']; ?></td>
                                            <td class=" "><?php echo $v['e_name']; ?></td>
                                            <td class="center  "><?php echo $v['sort']; ?></td>
                                            <td class=" ">
                                                <a href="/Admin/Product/edit/id/<?php echo $v['id']; ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>
                                                    修改</a>
                                                <a href="/Admin/Product/delete/id/<?php echo $v['id']; ?>" class="btn btn-danger btn-xs delete"><i
