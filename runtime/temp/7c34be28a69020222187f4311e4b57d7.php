<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\link\add.html";i:1592377543;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" placeholder="链接名称(长度:1-20位)">
													</div>
												</div>
...
<!--													<div class="col-sm-10">-->
<!--														<input type="text" class="form-control" id="inputPassword3" name="url" placeholder="请输入友情链接地址">-->
<!--													</div>-->
<!--												</div>-->
