<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\banner\add.html";i:1591691747;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1591688415;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail23" name="lname" placeholder="主标题名称(长度:1-20位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" placeholder="副标题名称(长度:1-50位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword13" name="btn_name" placeholder="请输入按钮名称(长度:1-10位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword3" name="url" placeholder="请输入完成的跳转路径">
													</div>
												</div>

												<div class="form-group">
													<label for="inputPassword6" class="col-sm-2 control-label no-padding-right">轮播图排序</label>
													<div class="col-sm-10">
