<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\product\add.html";i:1592897906;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" placeholder="产品名称(长度:1-255位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword3" name="e_name" placeholder="请输入产品英文名(长度:1-255位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail323" value="" name="keywords" placeholder="请输入产品关键词">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<textarea name="desc" cols="30" rows="10" class="form-control" placeholder="请输入产品简介(长度不超过255)"></textarea>
													</div>
												</div>
