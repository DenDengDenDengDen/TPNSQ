<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\cate\edit.html";i:1591771398;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1591770879;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">图片(建议尺寸:400*150)</label>
													<div class="col-sm-10">
														<input type="file" class="form-control" id="inputEmail23" name="img">
													</div>
												</div>
												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right"></label>
													<div class="col-sm-10">
														<img style="width:400px;height:150px;" src="<?php echo $data['img']; ?>" alt="">
													</div>
												</div>

												<div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label no-padding-right">类别名称</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" value="<?php echo $data['name']; ?>" placeholder="类别名称(长度:1-20位)">
													</div>
												</div>

												<div class="form-group">
													<label for="inputPassword6" class="col-sm-2 control-label no-padding-right">排序值</label>
													<div class="col-sm-10">
