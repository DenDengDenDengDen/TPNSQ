<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\article\add.html";i:1592295600;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1573785337;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592294140;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail3" name="name" placeholder="文章标题(长度:1-20位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputPassword3" name="author" value="admin" placeholder="请输入作者名(长度:1-20位)">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail23" value="本站" name="origin" placeholder="请输入文章来源">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="inputEmail323" value="" name="keywords" placeholder="请输入文章关键词">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<textarea name="desc" cols="30" rows="10" class="form-control" placeholder="请输入文章简介(长度不超过255)"></textarea>
													</div>
												</div>
