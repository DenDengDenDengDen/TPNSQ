<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\cate\index.html";i:1591771021;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">资讯管理</span>
                            ...
                            <div class="widget-body">
                                <div class="table-toolbar">
                                    <a id="editabledatatable_new" href="/Admin/Cate/add" class="btn btn-default">
                                        新增分类
                                    </a>
                                </div>
                                <div role="grid" id="editabledatatable_wrapper"
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable no-footer"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class=" ">
                                                <a href="/Admin/Cate/edit/id/<?php echo $v['id']; ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>
                                                    修改</a>
                                                <a href="/Admin/Cate/delete/id/<?php echo $v['id']; ?>" class="btn btn-danger btn-xs delete"><i
