<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpstudy_pro\WWW\cms\public/../application/admin\view\index\logo.html";i:1591838843;s:63:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\navbar.html";i:1592381958;s:64:"D:\phpstudy_pro\WWW\cms\application\admin\view\base\sidebar.html";i:1592819200;}*/ ?>
﻿<!DOCTYPE html>
<!--
										...
										<div>
											<form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="inputEmail23" class="col-sm-2 control-label no-padding-right">LOGO图片(建议尺寸:214*92)</label>
													<div class="col-sm-10">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<img src="<?php echo $logo; ?>" style="width:142px;height:38px;" alt="">
													</div>
												</div>
